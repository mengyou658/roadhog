...
exports.default = function (config, cwd) {
  ...
  var finalWebpackConfig = _extends({
    ...
    module: {
      rules: [].concat(_toConsumableArray((0, _common.getFirstRules)({ config: config, paths: paths, babelOptions: babelOptions })), _toConsumableArray((0, _common.getCSSRules)('development', { config: config, paths: paths, cssLoaders: cssLoaders, theme: theme })), _toConsumableArray((0, _common.getLastRules)({ paths: paths, babelOptions: babelOptions })))
    },
  ...
  return (0, _addExtraBabelIncludes2.default)(config, finalWebpackConfig, paths, config.extraBabelIncludes, babelOptions);
};
